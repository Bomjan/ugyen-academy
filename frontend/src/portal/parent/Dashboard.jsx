  ...
  return (
    <div className="min-h-screen bg-[#0A0A0C] text-white p-6">
      <div className="max-w-5xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-1">Welcome, {user?.name?.split(' ')[0] || 'Parent'}</h1>
          <p className="text-white/40 text-sm">Monitoring {childName}'s progress at Ugyen Academy</p>
        </div>

        {!childId && (
          <div className="bg-[#141416] border border-yellow-500/20 rounded-2xl p-6 mb-6 text-center">
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2">
            <div className="flex items-center justify-between mb-3">
              ...
              <Link to="/portal/parent/announcements" className="text-[#0066CC] text-xs hover:text-[#0077ED]">View all</Link>
            </div>
